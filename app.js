...
var addButton=document.querySelector(".btn--new-item");//first button
var incompleteTaskHolder=document.getElementById("todo__incomplete-tasks");//ul of #todo__incomplete-tasks
var completedTasksHolder=document.getElementById("todo__complete-tasks");//todo__complete-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("justify");
    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList.add("todo__item__checkbox")
    editInput.type="text";
    editInput.classList.add("justify");
    editInput.classList.add("todo__item__input");
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #todo__complete-tasks
    var listItem=this.parentNode;
